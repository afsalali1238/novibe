...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "icon", type: "image/png", sizes: "192x192", href: "/novibe-icon-192.png" },
      { rel: "icon", type: "image/png", sizes: "512x512", href: "/novibe-icon-512.png" },
      { rel: "apple-touch-icon", href: "/novibe-icon-192.png" },
